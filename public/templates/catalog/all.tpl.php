        ...
        <div class="col-md-3" id="search" >
            <div class="container">
                <div class="input-group mb-3">
                    ...
                    <input type="text" pattern="[a-zA-Zа-яА-Я]*" class="form-control" id="input-name-desc" aria-describedby="basic-addon3">
                </div>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                ...
                <input type="button" class="btn btn-warning" value="Поиск" onclick="searchBooks()" style="float: right">
            </div>
        </div>
